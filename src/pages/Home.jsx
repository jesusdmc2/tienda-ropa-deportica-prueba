        ...
        <>
            ...
            <section className="relative h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                    <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter leading-tight mb-6">
                        TU MEJOR VERSIÓN <br /> <span className="text-primary">EMPIEZA AQUÍ</span>
                    </h1>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                        <Link
                            to="/precios"
                            className="w-full sm:w-auto bg-primary text-white px-10 py-5 rounded-full font-black uppercase tracking-widest text-lg hover:scale-105 transition-all shadow-xl shadow-primary/20"
                        >
                            Empieza tu prueba gratis
                        </Link>
                        <Link
                            to="/programas"
                            className="w-full sm:w-auto border-2 border-white/20 hover:border-white text-white px-10 py-5 rounded-full font-black uppercase tracking-widest text-lg transition-all backdrop-blur-sm"
                        >
                            Ver programas
                        </Link>
                    </div>
            ...
            <section className="py-24 px-4">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="glass p-10 rounded-xl hover:bg-white/5 transition-all group">
                            <div className="bg-primary/20 w-16 h-16 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                                <span className="material-icons text-primary text-3xl">monitoring</span>
                            </div>
            ...
            <section className="py-24 px-4 bg-zinc-950">
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-12 gap-6">
                        ...
                        <Link to="/programas" className="text-primary font-bold uppercase tracking-widest text-sm flex items-center gap-2 hover:gap-4 transition-all">
                            Ver todos los programas <span className="material-icons">arrow_forward</span>
                        </Link>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {/* Program 1 */}
                        <div className="group relative overflow-hidden rounded-xl bg-[#0A0A0A]">
                            <div className="h-80 overflow-hidden">
                                <img alt="Quema Total HIIT" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 opacity-70" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAcp_UnC4drAm5Nnn6_T6Gb-L10GQgy-cYgY1bGHmPs0FRpz7JxjqV3Dbp27zk4uwIbK7fHaJ_ck-DRBmLTYcTKYXxHytRfeWOJJGm4VVNmc-3B0WjPMTJFpNzPSQgwNa3yJypGJ074fqnLYTUFgA7oGECxDOW2Ink6O2FLBZYBArw4burNh4SlovBGAQDtC_MGBfKhVC0jDqQmtvOdczzBOgo0qhP7Z67LpWTHnIJNwBWUmndtCigM1y7EYASNmkkhFjzLWGduuNkq" />
                            </div>
                            ...
                            <div className="p-6">
                                ...
                                <Link to="/programas" className="inline-flex items-center gap-2 text-primary font-bold uppercase tracking-widest text-xs">
                                    Ver más <span className="material-icons text-sm">add</span>
                                </Link>
                            </div>
                        </div>
                        {/* Program 2 */}
                        <div className="group relative overflow-hidden rounded-xl bg-[#0A0A0A]">
                            <div className="h-80 overflow-hidden">
                                <img alt="Fuerza Élite" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 opacity-70" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrkyD-aSqPlDWnnoI8vO7h8XGi7e2M-SSG6j6X5tlXtQIFlFmlqlw_Iefmfhq3AU-KtbJmFwDkEzp3BuNqyxACHjgdBqh3s884tEUG99x1zNmvA7ADeJ5tdME7V2h20FnH6Lut9d054LtNhsXgnbRm2qHcnnUmMm1qZIaL0FYJWDsKVY6J7noPQfLtawLClbLYOXqWEX-0_6WEzJ0suDVlXHzzOmOybwR-paqgZMSy7yDG3APbXHAeAji8TcjgnbJriSvLfoatZ8b0" />
                            </div>
                            <div className="absolute top-4 left-4 flex gap-2">
                        ...
                        <div className="group relative overflow-hidden rounded-xl bg-[#0A0A0A]">
                            <div className="h-80 overflow-hidden">
                                <img alt="Rendimiento Atlético" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500 opacity-70" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB-a4mCI6ndbP_Iawv407oqHuTas7ktYU70wY3xCFXubyvGbzMFEq0GrjKMBGDpGZe3Zpr3grYckcwk7OW-LJquzvwp4OQcxLhPxYQqX-neHQ6rn1jORzLbxK7PGw2b6HND0C27OX5TAsJABUK5yusQGK4XcxIP_fKq5T73uBkehx2c6jbTycXXxz64bu24TJ5wF4BqHDwYV2Hpdyblo1LYrftgqhZ9-VVs5Yq1Yo7yopUh-lB__Dk8Fxh40rheoOdMobhkwCGxOTpE" />
                            </div>
                            <div className="absolute top-4 left-4 flex gap-2">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        ...
                        <div className="glass p-8 rounded-xl max-w-sm border-primary/30">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="w-12 h-12 rounded-full overflow-hidden">
                                    <img alt="Marcos Rivera" className="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBpcJDPBLOTfMRA9kD-g8Y5PFaJ30ZLhOIM9yLRo4Hwr9yDHN4SVClyPY8dAS62JR-bbu53v0r8x6gAkMFLNt9pd_CzAE8AaMSPHC72wrfXSa0LsXxK9dB9XK1haXj_aXQa8ICXrDHDjQdQ_-8si7ezSezjS032hiXgH8TpW4fH7JEVy7WGcUv6t_U0b38KqJxy8IUH-2gZVO3uDnFgutnQVceCqsIcI-Ogx-hoKcuROIPqOQItjr5BqO_cXiEAIXq0i4N5KLGLMqKV" />
                                </div>
                                <div>
            ...
            <section className="py-24 px-4">
                <div className="max-w-6xl mx-auto relative rounded-lg overflow-hidden p-12 md:p-24 text-center">
                    ...
                    <img alt="Gym Background" className="absolute inset-0 w-full h-full object-cover mix-blend-overlay z-0" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAV6NTojCi-TGhgptAXURCZYno8W25sAl9nnsfG8zpT07g7R2iwLxOsXheHG3u0xKQg6uZu2kTinXQpcs0dKxPOKqA9hKAK3L_ZqvPZ5hfGd8tvjfWxf8wEtq6FmW46Mcu0JqJ1Q-xjYarzkNCU3Ex3b6GHtRsJwJuCTFfwRLmCKxbtTHLDcFq2of0pK-dc96L0GUEQ_xm0izrM8cGbfz8WbvctHRZpNdCaGwb_61rXkxxi6Wr1sy8a7loZrgVYg2v2JmikZiGlHPGr" />
                    <div className="relative z-10">
                        ...
                        <Link to="/precios" className="bg-white text-primary px-12 py-5 rounded-full font-black uppercase tracking-widest text-xl hover:bg-slate-100 transition-colors shadow-2xl inline-block">
                            Comienza Ahora
                        </Link>
                    </div>
                </div>
